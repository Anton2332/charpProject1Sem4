...
namespace BLL_Project2.Interfaces
{
    ...
    {
        Task AddAsync(OrderRequestDTO order);
        Task UpdateAsync(OrderRequestDTO order);
        Task DeleteAsync(int id);
        Task<IEnumerable<OrderResponseDTO>> GetAllByAllIdAndOrderByNameDescAsync(List<int> allId, int pageNumber);
